...
CREATE TABLE `bonuses` (
  ...
  `type` enum('user','guest') COLLATE utf8mb4_unicode_ci NOT NULL,
  `value` int NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `bonus_date` date NOT NULL DEFAULT (curdate()),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_user_date` (`user_id`,`bonus_date`),
  UNIQUE KEY `uniq_ip_date` (`ip`,`bonus_date`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `photo_changes`
--
...
CREATE TABLE `photo_changes` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_changes_photo` (`photo_id`),
  KEY `fk_changes_user` (`user_id`),
  CONSTRAINT `fk_changes_photo` FOREIGN KEY (`photo_id`) REFERENCES `photos` (`id`),
...
-- Dump completed on 2025-11-18 22:41:00
